			...
			<nav class="navbar navbar-default" role="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li>
							<a href="/content/nb-gardens-web-project/login-page/user-main-page.html">Home</a>
						</li>
                        <li>
							<a href="/content/nb-gardens-web-project/login-page/user-main-page/products.html">Products</a>
						</li>
                         <li>
							<a href="/content/nb-gardens-web-project/login-page/user-main-page/custom-products.html">Custom Products</a>
						</li>
                        <!--
						<li class="dropdown">
		...
		<!--			<form class="navbar-form navbar-left" role="search">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="/content/nb-gardens-web-project/login-page/userHelp.html">Help</a>
								</li>
								<li class="divider">
								</li>
								<li>
